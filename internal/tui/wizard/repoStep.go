...
func NewRepoStep(workspaces []*workspace.Workspace, purpose string) RepoStep {
...
func (m RepoStep) Init() tea.Cmd {
	return textinput.Blink
}

func (m RepoStep) Update(msg tea.Msg) (RepoStep, tea.Cmd) {
	var cmds []tea.Cmd
...
func (m RepoStep) updateAdding(msg tea.Msg) (RepoStep, tea.Cmd) {
	var cmds []tea.Cmd
...
func (m RepoStep) viewAdding(titleStyle, borderStyle lipgloss.Style) string {
	...
	content := lipgloss.JoinVertical(
		...
		"\n",
		lipgloss.NewStyle().Foreground(lipgloss.Color("#D4D4D4")).Render("URL: ")+m.urlInput.View()+urlFocusIndicator,
		lipgloss.NewStyle().Foreground(lipgloss.Color("#D4D4D4")).Render("Ref: ")+m.refInput.View()+refFocusIndicator,
		"\n",
	)
...
func (m RepoStep) IsDone() bool {
	return m.done
}

func (m RepoStep) IsCancelled() bool {
	return m.cancelled
}

func (m RepoStep) GetResult() interface{} {
	return m.repositories
}

func (m RepoStep) GetRepositories() []workspace.RepositoryOption {
	return m.repositories
}
